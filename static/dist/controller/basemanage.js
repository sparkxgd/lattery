        ...
        l.render({//胜负彩赔率分析管理的表格3
            ...
            cols: [[{
                ...
                templet: function (obj) {
                    ...
                    arr.push(arr_mr.sort(function (a, b) {
                        return a - b
                    }));
                    arr.push(" </br> ");

                    //分析方式2（一赔的第一第二必选，任意选1场；去除二赔的任意5场；再去除三赔任意7场，最终留下来的结果。除了一赔第一第二，在任选7场为预测结果：）
                    //定义14场都是310
                    var p2_14 = ["310", "310", "310", "310", "310", "310", "310", "310", "310", "310", "310", "310", "310", "310"];
                    //找出一赔的第一第二
                    //三赔任选7场
                    var ag3 = 1;
                    var arr_mr3 = [];
                    ...
                    for (var i = 0; i < arr_mr2.length; i++) {
                        for (var k in pei_2) {
                            if (pei_2[k].ordernum == arr_mr2[i]) {
                                //移除掉
                                var j = arr_mr2[i] - 1;
                                var spf = pei_2[k].spf;
                                var a = p2_14[j].replace(spf, '');
                    ...
                    for (var k in pei_1) {
                        ...
                        var tip = "场次：" + d.ordernum + " 胜平负：" + d.spf + " 开奖：" + r;
                        for (var i = 0; i < p2_14.length; i++) {
